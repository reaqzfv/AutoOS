...
public static class BiosSettingRecommendationsList
{
    ...
    [
        ...
        new BiosSettingRecommendation { SetupQuestion = "DDR5 Robust Training Mode", Type = "Option", RecommendedOption = "Enabled" },
        ...
        new BiosSettingRecommendation { SetupQuestion = "ASPM Mode Control", Type = "Option", RecommendedOption = "Disabled" },
