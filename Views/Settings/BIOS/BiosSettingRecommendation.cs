...
public static class BiosSettingRecommendationsList
{
    ...
    [
        ...
        new BiosSettingRecommendation { SetupQuestion = "Address Hash Bank", Type = "Option", RecommendedOption = "Disabled" },
        new BiosSettingRecommendation { SetupQuestion = "Address Hash CS", Type = "Option", RecommendedOption = "Disabled" },
        new BiosSettingRecommendation { SetupQuestion = "Address Hash RM", Type = "Option", RecommendedOption = "Disabled" },
        new BiosSettingRecommendation { SetupQuestion = "Address Hash Subchannel", Type = "Option", RecommendedOption = "Disabled" },
        ...
        //new BiosSettingRecommendation { SetupQuestion = "Download & Install MyASUS service & app", Type = "OptioInternal PCIe GPP 0 D3n", RecommendedOption = "Disabled" }, // already disabled by default
