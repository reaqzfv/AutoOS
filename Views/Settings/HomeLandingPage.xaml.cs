    ...
    public sealed partial class HomeLandingPage : Page
    {
        ...
        private async Task Update()
        {
            ...
            var actions = new List<(string Title, Func<Task> Action, Func<bool> Condition)>
            {
                ...
                // increase mouse hover time on tooltips
                ("Increasing mouse hover time on tooltips", async () => await ProcessActions.RunNsudo("CurrentUser", @"reg add ""HKEY_CURRENT_USER\Control Panel\Mouse"" /v MouseHoverTime /t REG_SZ /d 150 /f"), null),

                // increase delay when opening submenus
                ...
                // set "slide show" to "available"
                (@"Setting ""Slide show"" to ""Available""", async () => await ProcessActions.RunNsudo("CurrentUser", @"powercfg /setacvalueindex scheme_current 0d7dbae2-4294-402a-ba8e-26777e8488cd 309dce9b-bef4-4119-9921-a851fb12f0f4 0"), null),
